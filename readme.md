...
Проект "ШколПит" представляет собой веб-приложение, позволяющее ученикам, поварам и администраторам организовывать работу в школьных столовых.
...
The project was created by the team "Не хухры-мухры" ("Ne huhryu-muhryu"), consisting of Kirill Artimovich, Ivan Bezzubtsev, Dmitry Kuznetsov, Evgeny Pushkarev, and Denis Ushakov.

Case #2 "Cafeteria Management"
